...
def getOGFileAttachment(instance , filename ):
    return 'blogs/%s_%s' % (str(time()).replace('.', '_'), filename)
...
class blogPost(models.Model):
    ...
    ogvideo = models.FileField( upload_to= getOGFileAttachment , null = True)
    ...
    language = models.CharField(choices = LANGUAGE_CHOICES , default = 'en' , max_length = 20)
