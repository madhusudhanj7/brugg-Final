    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ogvideo', models.FileField(null=True, upload_to=PIM.models.getOGFileAttachment)),
                ...
                ('language', models.CharField(choices=[(b'en', b'en'), (b'jp', b'jp'), (b'de', b'de'), (b'es', b'es'), (b'fr', b'fr')], default=b'en', max_length=20)),
