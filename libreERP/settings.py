...
SITE_ADDRESS = 'http://127.0.0.1:9000' # the url prefix of the site
...
ERP_URL_PREFIX = 'http://127.0.0.1:9000'
APIMANAGER_URL_PREFIX = 'http://127.0.0.1:9000'
...
ALLOWED_HOSTS = ['192.168.1.5','192.168.0.26','192.168.1.16','192.168.0.21', 'cioc.co.in', 'localhost', '127.0.0.1', '192.168.0.105', '192.168.0.105' ,'172.20.10.8', '192.168.1.113' ,'192.168.1.109' , '192.168.1.110' , '192.168.0.113','192.168.0.15','192.168.1.123','192.168.0.6','192.168.1.2']
...
BRAND_NAME = 'BRUGG LIFTING'

BRAND_LOGO = '/static/images/brugglifting.svg'
BRAND_LOGO_INVERT = '/static/images/brugglifting.svg'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'HR', 'templates'),
            ...
            os.path.join(BASE_DIR, 'brugg', 'templates'),
...
G_ADMIN=['vigneshraj13795@gmail.com']
...
LANG_FOR_SOCIAL = {
    'linkedin':{
        ...
        'en':'https://in.linkedin.com/company/brugg-lifting',
        'fr':'https://in.linkedin.com/company/brugg-lifting',
        'es':'https://in.linkedin.com/company/brugg-lifting',
        'de':'https://in.linkedin.com/company/brugg-lifting',
        'jp':'https://in.linkedin.com/company/brugg-lifting',
    },
    'facebook':{

        'en':'https://www.facebook.com/brugglifting/',
        'fr':'https://www.facebook.com/brugglifting/',
        'es':'https://www.facebook.com/brugglifting/',
        'de':'https://www.facebook.com/brugglifting/',
        'jp':'https://www.facebook.com/brugglifting/',
    },
    'twitter':{

        'en':'https://twitter.com/brugg_lifting?lang=en',
        'fr':'https://twitter.com/brugg_lifting?lang=fr',
        'es':'https://twitter.com/brugg_lifting?lang=es',
        'de':'https://twitter.com/brugg_lifting?lang=de',
        'jp':'https://twitter.com/brugg_lifting?lang=jp',
    },
    'youtube':{

        'en':'https://www.youtube.com/channel/UC3HcQc4mAP6pBQ9hcTlKxzw',
        'fr':'https://www.youtube.com/channel/UC3HcQc4mAP6pBQ9hcTlKxzwhttps://www.youtube.com/channel/UC3HcQc4mAP6pBQ9hcTlKxzw',
        'es':'https://www.youtube.com/channel/UC3HcQc4mAP6pBQ9hcTlKxzw',
        'de':'https://www.youtube.com/channel/UC3HcQc4mAP6pBQ9hcTlKxzw',
        'jp':'https://www.youtube.com/channel/UC3HcQc4mAP6pBQ9hcTlKxzw',
    },
}
