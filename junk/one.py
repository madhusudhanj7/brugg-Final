...
# c.drawImage(logo3,0.4*inch,4.6*inch,width=0.5*inch,height=0.5*inch)
# c.drawImage(logo3,0.4*inch,3.8*inch,width=0.5*inch,height=0.5*inch)
# c.drawImage(logo3,0.4*inch,3*inch,width=0.5*inch,height=0.5*inch)
# c.drawImage(logo3,0.4*inch,2.1*inch,width=0.5*inch,height=0.5*inch)
# c.drawImage(logo3,0.4*inch,1.4*inch,width=0.5*inch,height=0.5*inch)
# c.drawImage(logo3,0.4*inch,0.78*inch,width=0.5*inch,height=0.5*inch)
...
p.rect(455, 6.07*inch, 7*inch, 0.2*inch)
# p.rect(2, 3*inch, 1*inch, 1*inch)
c.clipPath(p, stroke=0)
c.linearGradient(0*mm, 30*mm, 20*mm, 10*mm, ('#DAA520','#D4AF37'),extend=True)
...
# Headers
hdescrpcion = Paragraph('''<b></b>''', styleBH)
hpartida = Paragraph('<para fontsize=7><b>A</b></para>', styleBH)
hcandidad = Paragraph('<para fontsize=7><b>B</b></para>', styleBH)
hcandidadt = Paragraph(''+'   '+'''<b></b>''', styleBH)
hprecio_unitario = Paragraph('<para fontsize=7><b>C</b></para>', styleBH)
hprecio_total = Paragraph('<para fontsize=7><b>D</b></para>', styleBH)
hprecio_empty1 = Paragraph(''+''' ''', styleBH)
hprecio_empty2 = Paragraph(''+''' ''', styleBH)
# hprecio_empty3 = Paragraph(''+''' ''', styleBH)
...
data= [[hdescrpcion, hpartida,hcandidad,hcandidadt, hprecio_unitario, hprecio_total, hprecio_empty1,hprecio_empty2],
...
table = Table(data, colWidths=[1.75 * cm, 2.65 * cm, 2.65 * cm,
                               2.65* cm, 2.65 * cm, 2.65*cm],rowHeights =12*mm)
...
c.clipPath(p, stroke=0)
c.linearGradient(150*mm, 600*mm, 20*mm, 10*mm, ('#B8860B','#B8860B'),extend=True)
c.setFont('Helvetica-Bold', 17)
c.setFillColor(colors.black)
...
# c.setFont('Helvetica-Bold', 10)
# c.drawString(20,200,"2")
#
# c.setFont('Helvetica-Bold', 10)
# c.drawString(20,300,"3")
