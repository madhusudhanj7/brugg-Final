...
//       '<span class="pull-right" style="cursor:pointer; font-size:15px;"><i class="fa fa-chevron-up" id="toggle" ></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-close" id="closeChatWindow" ></i></span>'+
//     '</div>'+
//   '</div>'+
...
//
//
//     document.getElementById("closeChatWindow").style.display="none";
//
//   }());
//
//
...
//         if (chatOpen) {
//           chatWindowDiv.style.height = "100vh";
...
//     if (chatOpen) {
//       // fa fa-chevron-down
//       // console.log('ddddddddddddddddddddddddddddddddddddddddddddddddd',document.getElementById("toggle").className);
//       document.getElementById("closeChatWindow").style.display="";
//       document.getElementById("toggle").className = "fa fa-chevron-down";
//       var xs = window.matchMedia("(max-width: 767px)")
//       if (xs.matches) {
...
//         // }
//
//         document.getElementById("chatWindowDiv").style.height = "100vh";
...
//     }else {
//       document.getElementById("closeChatWindow").style.display="none";
//       document.getElementById("toggle").className = "fa fa-chevron-up";
//       var xs = window.matchMedia("(max-width: 767px)")
//       if (xs.matches) {
//         chatWindowDiv.style.display = "none"
//         floatDiv.style.display = ""
...
//       }else if (message.doc) {
//           attachedFile ='<p>  <a href="'+message.doc+'"> '+message.doc+' </a></p>'
//       }
//     }
//
  ...
  // };
    ...
    function messageDiv(message) {
      ...
      if (message.msg=='') {
        ...
        attachedFile = '<iframe width="100%" style="margin:0px;padding:0px;" height="240" src="'+message.link+'" frameborder="0" allowfullscreen></iframe>'
        }
      }
    ...
    function sendMessage(inptText) {
      ...
      var youtubeLink = inptText.includes("www.youtube.com/");

      if (youtubeLink) {
        var message = {msg:"" , link:inptText ,  sentByMe:true , created: new Date() }
      }else {
