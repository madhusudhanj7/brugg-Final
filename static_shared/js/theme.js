...
(function($) {
    ...
    if ($('.brand-carousel-onee').length) {
        $('.brand-carousel-onee').owlCarousel({
            loop: true,
            margin: 10,
            nav: true,
            navText: [
    ...
    if ($('.brand-carousel-product').length) {
        $('.brand-carousel-product').owlCarousel({
            loop: true,
            margin: 10,
            nav: false,
            navText: [
    ...
    if ($('.brand-carousel-accessories').length) {
        $('.brand-carousel-accessories').owlCarousel({
            loop: true,
            margin: 10,
            nav: false,
            navText: [
    ...
    if ($('.brand-carousel-one-images').length) {
        $('.brand-carousel-one-images').owlCarousel({
            loop: true,
            margin: 10,
            nav: false,
            navText: [
